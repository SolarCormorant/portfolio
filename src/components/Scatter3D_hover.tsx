              ...
              {Object.entries({
                ...
                <div key={key} className="field">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      handleChange(key as keyof typeof selected, e.target.value)
                    }
                  >
      ...
      ? [
          {
            ...
            marker: {
              symbol: "diamond",
              size: 8,
              color: objectiveColorMap[selected.objective] || "#FFFFFF",
              opacity: 0.9,
            },
            showscale: false,
          },
...
scene: {
  ...
  // O an tabloda gösterilen veri hangi dizi ise onu kullan
  const sourceData =
    selected.objective === "Pareto Front" ? dataPF : dataObjective;
...
/>
    ...
    <DataTable data={tableData} selectedIndex={selectedRowIndex} />
              </>
            ) : (
